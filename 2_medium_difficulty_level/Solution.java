...
public class Solution {
    ...
    while (!queue.isEmpty()) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        for (int j = 0; j < word.length; j++) {
          ...
          for (int k = 0; k < 26; k++) {
            word[j] = (char) ('a' + k);
            final String nextWord = String.valueOf(word);
            if (unvisited.contains(nextWord)) {
              if (nextWord.equals(endWord)) return distance;
              else {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(solution.ladderLength("cet", "ism", wordList3));
    ...
    System.out.println(solution.ladderLength("sand", "acne", wordList4));
  }
}
